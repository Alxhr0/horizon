...
# Codecs
rpm-ostree override replace --experimental --from repo="terra-extras" mesa-filesystem mesa-libgbm mesa-libglapi mesa-dri-drivers mesa-libEGL mesa-libGL mesa-vulkan-drivers 
